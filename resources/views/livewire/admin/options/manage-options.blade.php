<div>
    <section class="rounded-lg bg-white shadow-lg">
        ...
        <header class="border-b border-gray-200 px-6 py-2">
            <div class="flex justify-between">
                ...
                <x-button wire:click="$set('newOption.openModale', true)">
                    Nuevo
                </x-button>
            </div>
        ...
        <div class="p-6">
            <div class="space-y-6">
                @foreach ($options as $option)
                    <div class="relative rounded-lg border border-gray-200 pt-6 pb-4 px-4" wire:key="option-{{ $option->id }}">
                        {{-- Etiqueta pegada en la esquina superior izquierda --}}
                        <div class="absolute top-0 left-0 transform -translate-y-1/2 bg-white px-2">
                        ...
                        <div class="flex gap-6 flex-wrap mb-4">
                            {{-- Aquí va el input o contenido principal --}}
    ...
    <x-dialog-modal wire:model="newOption.openModale">
        <x-slot name="title">
            Crear nueva opcion 
        </x-slot>
                        ...
                        <div class="grid grid-cols-2 gap-6">
                            <div>
                                ...
                                @switch($newOption->type)
                                    @case(1)
                                        <x-input wire:model="newOption.features.{{ $index }}.value" class="w-full" placeholder="Ingrese el valor de la opcion" />
                                        @break
                                    @case(2)
                            ...
                            <div>
                                ...
                                <x-input wire:model="newOption.features.{{ $index }}.description" class="w-full" placeholder="Ingrese una descripcion" />
                            </div>
                        </div>                
                    </div>
                @endforeach
