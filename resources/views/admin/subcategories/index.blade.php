<x-admin-layout  :breadcrumbs="[
                ...
                <tbody>
                    @foreach ($subcategories as $subcategory)
                        ...
                        <td class="px-6 py-4">
                            ...
                            <a class="btn btn-yellow" href="{{ route('admin.subcategories.edit',$subcategory) }}">
                                Editar
                            </a>   
                        </td>
                    </tr>
    ...
    @else
        ...
        <div>
            <span class="font-medium">Info alert!</span> Todavia no hay familia de producto registradas.
        </div>
        </div>
    @endif
