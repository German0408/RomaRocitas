<x-admin-layout  :breadcrumbs="[
                ...
                <tbody>
                    @foreach ($categories as $category)
                        ...
                        <td class="px-6 py-4">
                            ...
                            <a class="btn btn-yellow" href="{{ route('admin.categories.edit',$category) }}">
                                Editar
                            </a>   
                        </td>
                    </tr>
    ...
    @else
        ...
        <div>
            <span class="font-medium">Info alert!</span> Todavia no hay categorias de producto registradas.
        </div>
        </div>
    @endif
